  ...
  return (
    <div className="flex justify-center items-center pt-3 pb-4 px-12">
      ...
      <Dropdown
        ...
        containerProp="text-sm h-12 w-24 flex items-center ml-2 p-2 hover:cursor-pointer"
        categoriesContainerProp="flex min-w-max flex-wrap absolute top-full z-10 bg-white border-2 border-solid border-slate-200 p-6"
        categoriesItemProp="h-14 basis-2/6 shrink-0 grow-0 hover:underline  cursor-pointer hover:text-blue-600"
      />
      ...
      <Dropdown
        ...
        spanProp="pr-12"
        containerProp="text-xs flex items-center pl-4 h-11 w-1/6 border-solid border-black border-y-2 border-r-2 border-l-0"
        categoriesContainerProp="flex flex-col flex-wrap absolute top-full inset-x-0 min-w-full right-0.5 z-10 bg-white border border-solid border-black  "
        categoriesItemProp="cursor-pointer px-3 hover:bg-blue-500 hover:text-white"
        iconSize={16}
      />
